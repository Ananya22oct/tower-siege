...
function setup(){
    ...
    block1=new Block(650,150,30,40);
    block2=new Block(680,150,30,40);
    block3=new Block(710,150,30,40);
    block4=new Block(740,150,30,40);
    block5=new Block(770,150,30,40);

    block6=new Block(680,100,30,40);
    block7=new Block(710,100,30,40);
    block8=new Block(740,100,30,40);
    block9=new Block(710,90,30,40);
